...
Static, mobile-first web app for Victorian landlords and property managers to complete a rental minimum standards self-check, record notes, and download a PDF report.
...
assets/app.js           App logic and PDF generation
...
- Any professional-check item is marked `Not ready`
